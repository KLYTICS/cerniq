...
- BATE score _correctness_ (a flagged agent's flagging is a product question, not an availability one).
...
3. No notice required for _loosening_ an SLO during incident response, but the incident postmortem must justify it.
