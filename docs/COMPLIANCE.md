...
| CC2.3   | External communication                   | Public spec + `/.well-known/audit-signing-key` for third-party verifiers. | `apps/api/src/modules/wellknown/wellknown.service.ts`                                              | PARTIAL — public docs site (`docs.okoroapp.com`) not yet live; M-014 |
...
| RS.CO-02 | Internal & external stakeholders kept informed | Status page TODO.                                       | —                                                                               | GAP — status page (`status.okoroapp.com`) not live; THREAT_MODEL.md acceptance gate |
...
| Status page                                   | GAP     | `status.okoroapp.com` not live (`docs/THREAT_MODEL.md` acceptance gate).                                                                                                                                                                             |
...
| Bug bounty programme                          | GAP     | `security@okoroapp.com` mailbox + a `SECURITY.md` advisory channel pending.                                                                                                                                                                          |
