---
title: AEGIS — Merge-train triage (2026-05-21)
...
# AEGIS — Merge-train triage (2026-05-21)
...
behind. One PR (#26) is already SUPERSEDED by [PR #32](https://github.com/KLYTICS/aegis/pull/32) and should
just close.
...
|----|-------|--------|--------|-------|
| [#26](https://github.com/KLYTICS/aegis/pull/26) | fix(spec-sync) M-056 regression | **Close** | unblocks #32 | Superseded by [#32](https://github.com/KLYTICS/aegis/pull/32) (broader scope; mergeable) |
| [#9](https://github.com/KLYTICS/aegis/pull/9) | fix(audit): SOC2 third-party verification (M-038) | Re-extract | SOC2 compliance | Compliance-critical; 39 real modifications + 79 stale deletions |
| [#2](https://github.com/KLYTICS/aegis/pull/2) | SDK VerifyGateway: 4-round enterprise hardening | Re-extract | Core SDK feature | 206 new files of substantive work |
| [#25](https://github.com/KLYTICS/aegis/pull/25) | feat(types,sdk-ts,dashboard): canonical DenialContextKind | Re-extract | Dashboard wiring | 177 new files; type-system feature |
| [#13](https://github.com/KLYTICS/aegis/pull/13) | feat(webhooks): payload contracts + drift observability | Re-extract | Webhook obs | Cross-cutting; needed for multi-tenant story |
| [#4](https://github.com/KLYTICS/aegis/pull/4) | fix(infra): enterprise quality pass | Re-extract | Infra hardening | 27 real code mods; auth + compliance |
| [#8](https://github.com/KLYTICS/aegis/pull/8) | chore(deps): close all 44 Dependabot alerts | Re-extract | Dep health | Batch with #16 |
| [#16](https://github.com/KLYTICS/aegis/pull/16) | chore(deps): W1 transitive sweep via pnpm.overrides | Re-extract | Dep health | 6 real mods; closes 15 alerts (4H/9M/2L) |
| [#14](https://github.com/KLYTICS/aegis/pull/14) | chore(husky): wire conflict-check pre-commit | Re-extract | Peer tooling | Smallest scope; 7 real mods |
...
1. **[#26](https://github.com/KLYTICS/aegis/pull/26) close** — 30 seconds, removes confusion, clears the
   "spec-sync regression fix" double-PR situation.
2. **[#9](https://github.com/KLYTICS/aegis/pull/9) (M-038 SOC2 audit chain)** — compliance-critical,
   lands SOC2 third-party verification work.
3. **[#16](https://github.com/KLYTICS/aegis/pull/16) (W1 dep sweep)** — closes 15 Dependabot alerts
   immediately (4 HIGH, 9 MEDIUM, 2 LOW). Highest security ROI per
   minute of re-extraction effort.
4. **[#25](https://github.com/KLYTICS/aegis/pull/25) (DenialContextKind)** — feature work that other
