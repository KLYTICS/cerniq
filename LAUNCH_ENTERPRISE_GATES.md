...
> LAUNCH.md sequences the deploy. PRODUCTION*CHECKLIST is the engineering gate.
> **This file** is what makes the launch \_enterprise-quality* vs _MVP-shipped_ — the non-engineering surfaces a Fortune-500 prospect's security/legal team will probe in their first week.

## Why "enterprise quality" is more than green CI

You can have 0 critical CVEs, 17 typecheck-clean workspaces, p99 17ms, and _still_ lose a $500K deal because:
