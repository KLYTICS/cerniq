/* ============================================================================
   AEGIS Brand Brief — DOCX generator
...
const benchmarks = [
  {
    ...
    steal: [
      ...
      "Keyboard-first design language. AEGIS is for builders — surface every action with a kbd hint and a Cmd-K palette.",
  ...
  },
  {
    ...
    caveat: "Vercel's brand is intentionally austere — almost cold. AEGIS needs more warmth in copy and the editorial serif moments to avoid feeling like a clone."
  },
  {
    rank: 3, name: "Stripe",
    ...
    steal: [
      ...
      "Brand architecture: a strong parent mark with named sub-products (Stripe Atlas, Stripe Issuing). When AEGIS spawns sub-products (Aegis Audit, Aegis Policies, Aegis Court), follow this exact pattern.",
  ...
  },
  {
    ...
    steal: [
      ...
      "Video and 3D-rendered scenes as the hero unit. AEGIS should commission a 3D render of the shield mark with aurora light, looping subtly, as the homepage hero.",
    ...
    caveat: "Apple has the budget to commission custom-rendered hero animations for every product page. AEGIS gets one signature 3D render and reuses it. Don't try to match Apple's volume."
  },
  {
    rank: 5, name: "Anthropic",
    tagline: "AI safety is a research and applied effort.",
    why: "AEGIS lives next door to Anthropic in market positioning (AI infrastructure, trust, safety). Visual harmony with Anthropic's brand prevents AEGIS from looking like an unrelated startup and accelerates the implicit credibility transfer for relying parties who already trust Claude.",
    steal: [
      ...
      "Warmth in a technical brand. Anthropic's off-white and cream tones soften the cold-tech default. AEGIS uses Halo (#F4F6FF) instead of pure white for the same reason.",
      "Conversational headline voice. 'A new way to build with Claude.' Our equivalent: 'Verified. Or it didn't happen.'",
      "Editorial-style essays as marketing. Anthropic's research posts are core brand. AEGIS should publish trust-and-safety essays in the same register."
    ],
  ...
  },
  {
    ...
    steal: [
      "Surprise and delight in microcopy. Arc's empty states, loading messages, and 404 page have personality. AEGIS verification successes should have a moment ('signed and sealed', 'verdict cached for 60s') without becoming twee.",
      "The animated product reveal video. Arc's launch films are paced like a movie trailer. AEGIS deserves a 60-second narrative film for the homepage hero.",
      "Soft shadows and rounded corners that feel hand-drawn. We borrow the warmth without going full skeuomorphic.",
      "Intentional onboarding choreography. Arc's first-run is a guided cinematic experience. AEGIS dashboard onboarding should be the same — not a checklist, a choreographed reveal."
    ],
    caveat: "Arc's whimsy is built on consumer-product latitude. AEGIS is infrastructure for compliance teams. Steal the feeling of care, not the playful illustrations."
  },
  {
    rank: 7, name: "Framer",
    ...
    caveat: "Framer's marketing is sometimes overcaffeinated — too many gradients, too many moving parts. AEGIS uses the same techniques with 30% of the volume."
  },
  {
    rank: 8, name: "Cloudflare",
    tagline: "Helping build a better Internet.",
    why: "Cloudflare is the closest peer in security/edge infrastructure brand category. They sell trust at scale, and their visual language balances technical credibility with broad-market accessibility — exactly AEGIS's brief.",
    steal: [
      "Technical product pages that explain mechanism, not just outcome. Cloudflare shows you the network diagram. AEGIS should show the verification flow diagram on the homepage.",
      "Dashboard-first product marketing. Their best marketing pages are the dashboard itself. AEGIS dashboard screenshots should be a primary marketing asset.",
      ...
      "Open-source SDK as brand. Workers SDK, the 'Build with Cloudflare' positioning. AEGIS @aegis/sdk should be similarly central to brand."
    ],
    caveat: "Cloudflare's orange + black is iconic; do not borrow. Their information density also tips into corporate — AEGIS keeps more whitespace and editorial restraint."
  },
  {
    rank: 9, name: "Cursor",
    ...
    steal: [
      ...
      "Command palette as primary navigation metaphor — Cmd-K everywhere. AEGIS dashboard should have the same.",
    ...
    caveat: "Cursor's brand voice is sometimes thin (a fork of VSCode + AI). AEGIS has a richer story to tell — neutrality, cryptography, the audit log. Lean into our depth."
  },
  {
    rank: 10, name: "Resend",
    ...
    steal: [
      "Docs as primary marketing surface. Resend's docs are the most-visited page on the site. AEGIS docs should be designed with marketing-grade attention.",
    ...
    caveat: "Resend is monochrome. AEGIS gets the aurora gradient as a single brand signature — more chromatic personality than Resend, less than Stripe."
  },
  {
    ...
    steal: [
      "Friendly copy voice on hard topics. Tailscale explains zero-trust networking like a good colleague would. AEGIS explains cryptographic verification with the same patience.",
      ...
      "Pricing for the underdog tier — generous free tier, hobbyist-friendly. AEGIS should have a 10K-verifications/mo free tier."
    ],
    caveat: "Tailscale's illustrations are charming and very on-brand for them. AEGIS doesn't do illustrations — our visuals are 3D-rendered marks, network diagrams, and dashboard screenshots."
  },
  {
    ...
    steal: [
      ...
      "Trust microcopy: 'FDIC insured up to $5M' — specific, numeric, verifiable. AEGIS equivalent: 'Sub-50ms p99 verify. SOC 2 Type II. Audit chain signed.'"
    ],
    caveat: "Mercury's product is regulated banking — they earn the seriousness. AEGIS gets there through architectural choices (no private keys, append-only audit) — show the architecture, don't claim regulatory status we don't have."
  }
];
...
const cover = [
  new Paragraph({ spacing: { before: 1800, after: 0 }, alignment: AlignmentType.LEFT, children: [
    new TextRun({ text: "AEGIS", font: FONT, size: 144, bold: true, color: COLOR.ink, characterSpacing: 200 })
  ]}),
  ...
  new Paragraph({ children: [new TextRun({ text: "Erwin Kiess-Alfonso  ·  Founding operator, AEGIS", font: FONT, size: 24, color: COLOR.ink })] }),
  new Paragraph({ spacing: { before: 200, after: 80 }, children: [
...
const sec1Strategy = [
  ...
  eyebrow("Mission"),
  lead("AEGIS is the neutral verification, policy enforcement, and behavioral attestation layer between AI agents and the services they act on. We hold only public keys, we sign only what we observed, and we are the Switzerland of agent identity — protocol-, vendor-, and model-neutral."),
  ...
  p("AEGIS is the verification and attestation layer"),
  ...
  p("The Sentinel + The Sage. AEGIS is watchful, neutral, illuminating. It is not a guard who challenges you at the gate; it is the credential that let you through to begin with."),

  eyebrow("The three tensions the brand must hold"),
  callout("Tension 01 — Infrastructure vs. emotional",
    "AEGIS must read as serious infrastructure (Linear / Vercel / Cloudflare) AND have moments of emotional warmth (Anthropic / Arc / Tailscale). Solution: 90% surgical sans, 10% editorial-serif italics. The serif is the moment we let the brand exhale."),
  callout("Tension 02 — Cryptographic vs. accessible",
    "AEGIS speaks Ed25519, EdDSA JWTs, and hash chains. But sales conversations happen with compliance officers and CTOs who want to feel safe, not impressed. Solution: lead with outcomes ('an agent acted, here's the receipt'), back with mechanism ('signed by ed25519:9f3a…')."),
...
const sec2Benchmarks = [
  ...
  lead("Twelve world-class brands AEGIS should study, in order of relevance to our brief. For each: why study them, the specific things to steal, and the things not to copy. The order is not a ranking of brand quality — it's the order in which their lessons matter to us."),
...
const sec3Voice = [
  h1("03  ·  Voice & Tone"),
  lead("AEGIS sounds like a senior engineer who has read the spec and is no longer impressed. Calm, technically literal, rarely effusive, never cute. The serif is where we let the human show through."),
  ...
  p("AEGIS is Switzerland — neutral on agent vendors, neutral on protocols, neutral on models. But neutrality is a stance, not an absence of voice. Our copy is precise, opinionated about how trust works, and unafraid to say what we don't do."),
  ...
  callout("DON'T",
    "\"AEGIS leverages cutting-edge cryptography to deliver enterprise-grade trust at scale for the agentic era.\""),
  callout("DO",
    "\"AEGIS verifies that an agent did what it claims. Ed25519 signatures, append-only audit. Sub-50ms p99 verify.\""),
  callout("DON'T",
...
const sec4Visual = [
  ...
  h2("Recommended primary  ·  The Aegis Shield"),
  ...
  bullet("Carries meaning — every element has a reason. Hexagon = stability. Bisector = audit chain. A = AEGIS. Anchor = verified point. No decoration."),
  ...
  bullet("Never combine the mark with another logo without the AEGIS team's review (e.g., joint-marketing assets)."),
  ...
  p("Most direct. A checkmark whose tail is a key tooth. Reserved as a verification badge motif (e.g., 'Verified by AEGIS' inline badge for relying-party UIs that want to display agent verification status to end users)."),
...
const sec5Color = [
  ...
  inlineMono([["Aegis Cyan    ", false], ["#5BE0FF", true], ["   ·  Primary brand. Verified state. The trust beacon.", false]]),
  inlineMono([["Aegis Violet  ", false], ["#8B6BFF", true], ["   ·  Cryptographic accent. Proof, identity.", false]]),
  ...
  p("These three colors are bound to AEGIS's denial precedence (see docs/SECURITY.md). Verified, Denied, Pending are the only verdict states. There is never a fourth."),
...
const sec6Type = [
  h1("06  ·  Typography"),
  lead("Three voices. A tight technical sans for UI. A humane sans for body. An editorial serif for the moments AEGIS has to feel human. The serif is the secret weapon — used once per page, always intentional."),
  ...
  bullet("The 404 page. The thank-you page. The moments AEGIS exhales."),
...
const sec7Spatial = [
  ...
  p("These are the only components AEGIS ships in v1. They cover ~95% of surfaces."),
...
const sec8Pages = [
  ...
  lead("The pages AEGIS must ship in Phase 1. Each entry is a brief: what the page is for, the visual pattern, and the one moment that earns the immersive treatment."),
  ...
  bullet("Section 03 — the architecture diagram: SVG, animated. Agent → AEGIS → Relying Party. Public key flows separate from the verification path. The diagram IS the marketing."),
  ...
  bullet("Vulnerability disclosure / security@aegis email."),
...
const sec9Ecosystem = [
  ...
  lead("AEGIS is positioned as standalone-but-compatible. It has its own gravitational mark and palette. Its type philosophy and motion language harmonize with Anthropic-adjacent products and the future Cerniq lineup, so they can coexist without clashing."),

  h2("Standalone-but-compatible — the rules"),
  bullet("AEGIS owns: the hexagonal shield mark, the aurora gradient, the Verified Light palette, the 'Switzerland of agent identity' positioning."),
  bullet("AEGIS shares with the broader ecosystem: Inter / Inter Tight / Instrument Serif / JetBrains Mono type stack, the 8pt grid, the cubic-bezier(0.16, 1, 0.3, 1) easing, the dark-canvas convention."),
  bullet("AEGIS does not share: its specific palette hexes, its mark, its tagline."),
  bullet("Result: in a portfolio shot, AEGIS reads as belonging to a coherent design family, but it is unmistakably its own product."),

  h2("Anthropic adjacency — the rules"),
  p("AEGIS lives next door to Anthropic in market category (AI infrastructure, trust). When co-marketing or appearing alongside Anthropic surfaces:"),
  ...
  bullet("Color contrast: Anthropic is warm (cream / coral). AEGIS is cool (Obsidian / cyan-violet). Side-by-side, they read as complementary categories — warm-creative + cool-infrastructural."),
  bullet("Voice harmony: both speak in restrained, technically literal language. Neither over-promises."),
  bullet("Forbidden: do not put the AEGIS shield on a cream Anthropic-style background. The mark is dark-canvas-only."),

  h2("Cerniq sister-brand — the rules"),
  p("AEGIS and Cerniq (the operator's other product) should read as sister brands when shown together — same family, different purposes."),
  bullet("Shared spine: type stack, motion curve, 8pt grid, dark-canvas convention."),
  bullet("Distinct signatures: Cerniq has its own palette and mark; AEGIS has the aurora and shield. Each brand owns its own gradient direction."),
  bullet("Co-branded surfaces (e.g., a portfolio page): use neutral typographic treatment — 'AEGIS · Cerniq · ___' as a typographic frieze, no logo lockup."),

  h2("Sub-product expansion (when AEGIS spawns child brands)"),
  p("When AEGIS adds named sub-products (e.g., Aegis Audit, Aegis Court, Aegis Policies), follow Stripe's brand architecture pattern."),
  bullet("Naming: 'Aegis [Module]' — never a standalone brand. The parent always comes first."),
  bullet("Mark: the parent shield is the only mark. Sub-products do not get their own logos."),
  bullet("Color: each sub-product gets one accent color drawn from the canvas palette (e.g., Aegis Audit might lead with Steel + Cyan; Aegis Court with Graphite + Violet). Never invent new accents."),
  bullet("Surfaces: sub-products live as sections on the AEGIS dashboard, not as separate apps. Marketing is unified at /products."),
];
...
const sec10Handoff = [
  ...
  bullet("Drop 03_design-tokens.css into apps/dashboard. Replace any existing color/spacing/type rules. Apply class .aegis-root to the root element."),
  ...
  bullet("Build the verify-log dashboard view. This is the screenshot that sells AEGIS in product demos — invest accordingly."),
  ...
  bullet("Status page on a separate subdomain (status.aegis.dev or similar)."),
  ...
  bullet("Domain — aegis.dev / aegis.id / agent-aegis.com — this affects logo lockup and word-mark length. Pick one."),
  ...
  h2("Closing"),
  p("AEGIS is the verification layer between AI agents and the world. It cannot afford to look like another startup. Every surface this brand touches should answer one question: would this make a careful relying-party engineer trust us with their production traffic?"),
...
const doc = new Document({
  creator: "AEGIS",
  title: "AEGIS — Brand & Design System v1.0",
  ...
  sections: [{
    ...
    headers: {
      default: new Header({ children: [new Paragraph({
        ...
        children: [new TextRun({ text: "AEGIS  ·  Brand & Design System v1.0", font: FONT, size: 16, color: COLOR.fog, characterSpacing: 40 })]
      })] })
    },
    footers: {
