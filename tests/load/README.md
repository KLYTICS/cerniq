...
export CERNIQ_E2E_REQUEST_TOKEN=eyJhbGc...   # pre-signed agent JWT
...
| `cerniq_verify_latency_ms` p95 | `< 200 ms` | end-to-end measured client-side |
...
iteration. CERNIQ replay protection (test 08) means every iteration but
