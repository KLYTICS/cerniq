...
// Cross-package parity gate for @cerniq/docs <WebhookEventCatalog/>.
//
...
describe('docs ↔ @cerniq/types webhook event parity', () => {
  const source = readFileSync(COMPONENT_PATH, 'utf8');

  it('imports WEBHOOK_EVENT from @cerniq/types', () => {
