...
// Cross-package parity gate for @cerniq/docs <TrustBandLegend/>.
//
...
describe('docs ↔ @cerniq/types trust band parity', () => {
  const source = readFileSync(COMPONENT_PATH, 'utf8');

  it('imports TRUST_BAND_THRESHOLDS from @cerniq/types', () => {
