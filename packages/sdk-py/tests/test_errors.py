...
from okoro.errors import from_status
...
def test_from_status_maps_correctly(status: int, exc_type: type[OkoroError]) -> None:
    err = from_status(
        status,
        message="m",
        request_id="rid",
...
def test_okoro_error_has_helpful_repr() -> None:
...
async def test_missing_keys_raises_okoro_error_eagerly() -> None:
