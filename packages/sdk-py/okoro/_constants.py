...
# ── HTTP headers ─────────────────────────────────────────────
OKORO_HEADER_API_KEY: Final[str] = "X-OKORO-API-Key"
OKORO_HEADER_VERIFY_KEY: Final[str] = "X-OKORO-Verify-Key"
OKORO_HEADER_REQUEST_ID: Final[str] = "X-Request-Id"
OKORO_HEADER_TOKEN: Final[str] = "X-OKORO-Token"
OKORO_HEADER_SIGNATURE: Final[str] = "X-OKORO-Signature"
OKORO_HEADER_IDEMPOTENCY: Final[str] = "Idempotency-Key"
...
# ── Defaults ─────────────────────────────────────────────────
DEFAULT_BASE_URL: Final[str] = "https://api.okorolabs.io/v1"
