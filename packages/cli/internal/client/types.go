// Package client wire types — projections of the AEGIS API spec at
// docs/spec/AEGIS_API_SPEC.yaml. Hand-rolled rather than generated:
...
//
//go:generate echo "regen plan: oapi-codegen -package api -generate types,client -o internal/api/api.gen.go ../../docs/spec/AEGIS_API_SPEC.yaml"
package client
