...
import { attachOkoroGuard } from '../../src/adapters/fastify.js';
...
describe('fastify adapter', () => {
  it('verifies and decorates request', async () => {
    ...
    attachOkoroGuard(app, { verifier });
    app.get('/p', async (req) => {
      // type-rationale: the plugin attaches okoro dynamically.
    ...
    const body = res.json() as { okoro: { agentId: string } };
