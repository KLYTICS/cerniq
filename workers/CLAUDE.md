...
without changing AEGIS security semantics.
...
- Worker typecheck: `pnpm --filter @aegis/cf-verify typecheck`
- Worker lint: `pnpm --filter @aegis/cf-verify lint`
