...
//   signature    = ed25519.sign(okoroAuditPrivateKey, sign_input)
//
...
export class AuditChainUtil {
   ...
   * the sha256 of the literal string "OKORO-AUDIT-GENESIS-v1".
   */
   ...
   * signers participate without exposing a private key bundle to OKORO code.
   */
