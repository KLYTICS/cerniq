import { TRUST_BAND_THRESHOLDS } from '@okoro/types';
      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {ORDERED.map(([band, threshold]) => {
            ...
            return (
              <tr key={band} className="border-t border-[var(--okoro-mist)]">
                ...
                <td className="px-4 py-3 text-[var(--okoro-fog)]">{meta.meaning}</td>
              </tr>
            );
          })}
        </tbody>
