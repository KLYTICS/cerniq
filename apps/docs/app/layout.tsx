...
export const metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_DOCS_URL ?? 'https://docs.cerniqapp.com'),
  title: 'CERNIQ Documentation',
  description:
...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body className="cerniq-canvas flex min-h-screen flex-col">
