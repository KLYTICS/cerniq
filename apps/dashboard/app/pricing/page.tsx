...
// when `OKORO_API_BASE_URL` is set, eliminating the dual-source drift
...
//
// OKORO sells to engineers; the tier table is the value prop. No
// marketing sermon.
...
export const metadata: Metadata = {
  title: 'Pricing · OKORO',
  description:
    'OKORO pricing — Free trial, Developer ($49/mo), Team ($299/mo), Scale ($1,499/mo), and Enterprise tiers for agent verification, policy enforcement, and audit.',
};
